...
def _translate_action(view, command: str, args: dict = None) -> dict:
    return {
        'action': command,
...
def _translate_motion(view, command: str, args: dict = None) -> dict:
    return {
        'motion': command,
...
class ViPasteAfter(ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_paste', {
            'before_cursor': False
        })
...
class ViGotoAlternateFile(ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_ctrl_hat')
...
class ViOpenMacrosForRepeating(RequireOneCharMixin, ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_at', {
            'name': self.inp
        })
...
class ViToggleMacroRecorder(RequireOneCharMixin, ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_q', {
            'name': self.inp
        })
...
class ViInsertAfterChar(ViOperatorDef):
    ...
    def translate(self, view):
        ...
        return _translate_action(view, 'nv_vi_a')
...
class ViShowFileStatus(ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_ctrl_g')
...
class ViExitEditor(ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_big_z_big_q')
...
class ViCloseFile(ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_big_z_big_z')
...
class ViGotoSymbolInProject(ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_go_to_symbol', {
            'globally': True
        })
...
class ViGotoSymbolInFile(ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_go_to_symbol', {
            'globally': False
        })
...
class ViGotoExactMarkXpos(RequireOneCharMixin, ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_backtick', {
            'character': self.inp
        })
...
class ViGotoMark(RequireOneCharMixin, ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_quote', {
            'character': self.inp
        })
...
class ViGotoOpeningBrace(ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_left_square_bracket', {
            'action': 'target',
            'target': '{'
        })
...
class ViForwardToStartOfChange(ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_right_square_bracket', {
            'action': 'c',
        })
...
class ViMoveDownByLines(ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_j', {
            'xpos': get_xpos(view)
        })
...
class ViMoveUpByLines(ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_k', {
            'xpos': get_xpos(view)
        })
...
class ViRepeatSearchForward(ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_repeat_buffer_search', {
            'reverse': False
        })
...
class ViReplaceCharacters(RequireOneCharMixin, ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_r', {
            'char': self.inp
        })
...
class ViSetMark(RequireOneCharMixin, ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_m', {
            'character': self.inp
        })
...
class ViATextObject(RequireOneCharMixin, ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_select_text_object', {
...
class ViSearchForwardImpl(ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_slash_impl', {
            'pattern': self.inp,
        })
...
class ViSearchBackwardImpl(ViMotionDef):
    ...
    def translate(self, view):
        return _translate_motion(view, 'nv_vi_question_mark_impl', {
            'pattern': self.inp,
        })
...
class Viz(ViOperatorDef):
    ...
    def translate(self, view):
        return _translate_action(view, 'nv_vi_z', {

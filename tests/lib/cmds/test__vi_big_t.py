...
NORMAL_CASES = (
    test_data('0x23a5', (4, 4), 'x', ViewTestCase.modes.NORMAL, (2, 2), 'Find behind'),
    test_data('012xa5', (4, 4), 'x', ViewTestCase.modes.NORMAL, (4, 4), 'Find previous'),
    test_data('0123x5', (4, 4), 'x', ViewTestCase.modes.NORMAL, (4, 4), 'Find self'),
    test_data('0xx3a5', (4, 4), 'x', ViewTestCase.modes.NORMAL, (3, 3), 'Find multiple'),
    test_data('01x3x5', (4, 4), 'x', ViewTestCase.modes.NORMAL, (3, 3), 'Find self multiple'),
)

INTERNAL_NORMAL_CASES = (
    test_data('0x23a5', (4, 4), 'x', ViewTestCase.modes.INTERNAL_NORMAL, (4, 2), 'Find behind'),
    test_data('012xa5', (4, 4), 'x', ViewTestCase.modes.INTERNAL_NORMAL, (4, 4), 'Find previous'),
    test_data('0123x5', (4, 4), 'x', ViewTestCase.modes.INTERNAL_NORMAL, (4, 4), 'Find self'),
    test_data('0xx3a5', (4, 4), 'x', ViewTestCase.modes.INTERNAL_NORMAL, (4, 3), 'Find multiple'),
    test_data('01x3x5', (4, 4), 'x', ViewTestCase.modes.INTERNAL_NORMAL, (4, 3), 'Find self multiple'),
)

VISUAL_MULTI_CHAR_CASES = (
    test_data('0x2ba5', (5, 3), 'x', ViewTestCase.modes.VISUAL, (5, 2), 'Reverse'),
    test_data('0x23a5', (5, 1), 'x', ViewTestCase.modes.VISUAL, (5, 1), 'Reverse find b'),
    test_data('0ax3b5', (1, 5), 'x', ViewTestCase.modes.VISUAL, (1, 4), 'Forward no crossover'),
    test_data('0x2ab5', (3, 5), 'x', ViewTestCase.modes.VISUAL, (4, 2), 'Forward crossover'),
    test_data('01x3b5', (2, 5), 'x', ViewTestCase.modes.VISUAL, (2, 4), 'Forward find a'),
    test_data('01a3x5', (2, 5), 'x', ViewTestCase.modes.VISUAL, (2, 5), 'Forward find b'),
    test_data('0xb3a5', (5, 2), 'x', ViewTestCase.modes.VISUAL, (5, 2), 'Reverse find b-1'),
    test_data('0a2xb5', (1, 5), 'x', ViewTestCase.modes.VISUAL, (1, 5), 'Forward find b-1'),
    test_data('0xa3b5', (2, 5), 'x', ViewTestCase.modes.VISUAL, (2, 3), 'Forward find a-1'),
)
...
VISUAL_MULTI_MATCHES_CASES = (
    test_data('0xxba5', (5, 3), 'x', ViewTestCase.modes.VISUAL, (5, 3), 'Reverse find first'),
    test_data('01xxa5', (5, 3), 'x', ViewTestCase.modes.VISUAL, (5, 3), 'Reverse find b'),
    test_data('01xxb5', (3, 5), 'x', ViewTestCase.modes.VISUAL, (3, 5), 'Forward find a'),
    test_data('01xxb5', (2, 5), 'x', ViewTestCase.modes.VISUAL, (2, 5), 'Forward find a'),
    test_data('01xax5', (3, 5), 'x', ViewTestCase.modes.VISUAL, (3, 4), 'Forward find b'),
)
...
SKIP_CASES = (
    test_data('xxxx', (2, 2), 'x', ViewTestCase.modes.NORMAL, (1, 1), 'Skip past previous match'),
    test_data('xxxx', (1, 1), 'x', ViewTestCase.modes.NORMAL, (1, 1), 'Does not skip past final match'),
)

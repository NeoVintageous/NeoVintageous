...
TESTS_MODES = (
    ...
    test_data(cmd='_vi_k', initial_text='foo\nbar\nbaz\n', regions=[[(2, 1), (2, 1)]], cmd_params={'mode': unittest.NORMAL_MODE, 'xpos': 1, 'count': 100},  # noqa: E241,E501
              expected=region_data([(0, 1), (0, 1)]), actual_func=first_sel, msg='should not move too far (mode normal)'),  # noqa: E241,E501

    test_data(cmd='_vi_k', initial_text='foo\nbar\nbaz\n', regions=[[(1, 1), (1, 2)]], cmd_params={'mode': unittest.VISUAL_MODE, 'count': 1, 'xpos': 2},  # noqa: E241,E501
              expected=region_data([(1, 2), (0, 2)]), actual_func=first_sel, msg='move one line (visual mode)'),  # noqa: E241,E501
    test_data(cmd='_vi_k', initial_text='foo\nbar\nbaz\n', regions=[[(2, 1), (2, 2)]], cmd_params={'mode': unittest.VISUAL_MODE, 'count': 1, 'xpos': 2},  # noqa: E241,E501
    ...
    test_data(cmd='_vi_k', initial_text='foo\nbar\nbaz\n', regions=[[(1, 0), (2, 1)]], cmd_params={'mode': unittest.VISUAL_MODE, 'xpos': 0},  # noqa: E241,E501
    ...
    test_data(cmd='_vi_k', initial_text='foo bar\nfoo bar\nfoo bar\n', regions=[[(1, 4), (2, 4)]], cmd_params={'mode': unittest.VISUAL_MODE, 'xpos': 4, 'count': 2},  # noqa: E241,E501
    ...
    test_data(cmd='_vi_k', initial_text='foo\nbar\nbaz\n', regions=[[(0, 1), (1, 1)]], cmd_params={'mode': unittest.VISUAL_MODE, 'xpos': 0, 'count': 1},  # noqa: E241,E501
              expected=region_data([(0, 2), (0, 0)]), actual_func=first_sel, msg='move back to same line same xpos'),  # noqa: E241,E501

    test_data(cmd='_vi_k', initial_text='foo\nbar\nbaz\n', regions=[[(0, 2), (1, 0)]], cmd_params={'mode': unittest.VISUAL_MODE, 'xpos': 0, 'count': 1},  # noqa: E241,E501
    ...
    test_data(cmd='_vi_k', initial_text=(''.join(('foo\n',) * 50)), regions=[[(20, 2), (20, 1)]], cmd_params={'mode': unittest.VISUAL_MODE, 'xpos': 1, 'count': 10},  # noqa: E241,E501
              expected=region_data([(20, 2), (10, 1)]), actual_func=first_sel, msg='move many opposite end greater from same line'),  # noqa: E241,E501
    test_data(cmd='_vi_k', initial_text=(''.join(('foo\n',) * 50)), regions=[[(21, 2), (20, 1)]], cmd_params={'mode': unittest.VISUAL_MODE, 'xpos': 1, 'count': 10},  # noqa: E241,E501
...
MORE_TESTS = (
    test(content='''aaa
bbb
''', regions=((1, 1), (1, 1)), kwargs={'mode': unittest.NORMAL_MODE, 'count': 1, 'xpos': 1}, expected=((0, 1), (0, 1)), msg='from same length'),  # noqa: E241,E501

    test(content='''

''', regions=((1, 0), (1, 0)), kwargs={'mode': unittest.NORMAL_MODE, 'count': 1, 'xpos': 0}, expected=((0, 0), (0, 0)), msg='from empty to empty'),  # noqa: E241,E501

    test(content='''
aaa
''', regions=((1, 2), (1, 2)), kwargs={'mode': unittest.NORMAL_MODE, 'count': 1, 'xpos': 2}, expected=((0, 0), (0, 0)), msg='from longer to empty'),  # noqa: E241,E501

    test(content='''aaa

''', regions=((1, 0), (1, 0)), kwargs={'mode': unittest.NORMAL_MODE, 'count': 1, 'xpos': 0}, expected=((0, 0), (0, 0)), msg='from empty to longer'),  # noqa: E241,E501

    test(content='''aaa bbb
aaa
''', regions=((1, 2), (1, 2)), kwargs={'mode': unittest.NORMAL_MODE, 'count': 1, 'xpos': 2}, expected=((0, 2), (0, 2)), msg='from shorter to longer'),  # noqa: E241,E501

    test(content='''aaa
aaa bbb
''', regions=((1, 6), (1, 6)), kwargs={'mode': unittest.NORMAL_MODE, 'count': 1, 'xpos': 6}, expected=((0, 2), (0, 2)), msg='from longer to shorter'),  # noqa: E241,E501

    #     test(content='''\t\taaa
    # aaa bbb ccc
    # ''',
    #     regions=((1, 8), (1, 8)), kwargs={'mode': unittest.NORMAL_MODE, 'count': 1, 'xpos': 8}, expected=((0, 2), (0, 2)), msg='xpos with tabs'),  # noqa: E241,E501

    test(content='''aaa
aaa bbb ccc
''', regions=((1, 8), (1, 8)), kwargs={'mode': unittest.NORMAL_MODE, 'count': 1, 'xpos': 1000}, expected=((0, 2), (0, 2)), msg='xpos stops at eol'),  # noqa: E241,E501

    # VISUAL
    test(content='''aaa

ccc
''', regions=(((1, 0), (1, 1)),), kwargs={'mode': unittest.VISUAL_MODE, 'count': 1, 'xpos': 0}, expected=((1, 1), (0, 0)), msg='from empty to non-empty (visual)'),  # noqa: E241,E501

    test(content='''aaa bbb ccc ddd
aaa bbb ccc ddd
''', regions=(((0, 6), (1, 2)),), kwargs={'mode': unittest.VISUAL_MODE, 'count': 1, 'xpos': 2}, expected=((0, 7), (0, 2)), msg='from empty to non-empty (visual)'),  # noqa: E241,E501
)


class Test__vi_k_new(unittest.ViewTestCase):

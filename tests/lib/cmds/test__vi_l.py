...
class Test__vi_l_InNormalMode(ViewTestCase):
    ...
    def test_can_move_in_normal_mode(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.NORMAL_MODE, 'count': 1})
    ...
    def test_can_move_in_normal_mode_with_count(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.NORMAL_MODE, 'count': 10})
    ...
    def test_stops_at_right_end_in_normal_mode(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.NORMAL_MODE, 'count': 10000})
...
class Test__vi_l_InInternalNormalMode(ViewTestCase):
    ...
    def test_can_move_in_internal_normal_mode(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.INTERNAL_NORMAL_MODE, 'count': 1})
    ...
    def test_can_move_in_internal_normal_mode_with_count(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.INTERNAL_NORMAL_MODE, 'count': 10})
    ...
    def test_stops_at_right_end_in_internal_normal_mode(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.INTERNAL_NORMAL_MODE, 'count': 10000})
...
class Test__vi_l_InVisualMode(ViewTestCase):
    ...
    def test_can_move(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.VISUAL_MODE, 'count': 1})
    ...
    def test_can_move_reversed_cross_over(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.VISUAL_MODE, 'count': 5})
    ...
    def test_stops_at_eol_different_lines_reversed_large_count(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.VISUAL_MODE, 'count': 100})
    ...
    def test_can_move_with_count(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.VISUAL_MODE, 'count': 10})
    ...
    def test_stops_at_right_end(self):
        ...
        self.view.run_command('_vi_l', {'mode': self.VISUAL_MODE, 'count': 10000})

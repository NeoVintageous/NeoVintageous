...
TESTS = (
    ...
    test_data(content='abc',
              regions=[[(0, 0), (0, 0)]],
              in_register=['xxx'], params={'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 1},
              expected=('xxxabc', Region(2, 2)), msg='failed in {0}'),

    # INTERNAL NORMAL MODE - linewise
    test_data(content='abc',
              regions=[[(0, 0), (0, 0)]],
              in_register=['xxx\n'], params={'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 1},
              expected=('xxx\nabc', Region(0, 0)), msg='failed in {0}'),

    # VISUAL MODE
    test_data(content='abc',
              regions=[[(0, 0), (0, 3)]],
              in_register=['xxx'], params={'mode': ViewTestCase.modes.VISUAL, 'count': 1},
              expected=('xxx', Region(2, 2)), msg='failed in {0}'),

    # VISUAL MODE - linewise
    test_data(content='aaa bbb ccc',
              regions=[[(0, 4), (0, 7)]],
              in_register=['xxx\n'], params={'mode': ViewTestCase.modes.VISUAL, 'count': 1},

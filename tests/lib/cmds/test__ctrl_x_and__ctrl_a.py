...
TESTS = (
    test_data('abc aaa100bbb abc', [[(0, 0), (0, 0)]], {'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 10}, 'abc aaa110bbb abc', ''),  # noqa: E501, E241
    test_data('abc aaa-100bbb abc', [[(0, 0), (0, 0)]], {'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 10}, 'abc aaa-90bbb abc', ''),  # noqa: E501, E241

    test_data('abc aaa100bbb abc', [[(0, 8), (0, 8)]], {'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 10}, 'abc aaa110bbb abc', ''),  # noqa: E501, E241
    test_data('abc aaa-100bbb abc', [[(0, 8), (0, 8)]], {'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 10}, 'abc aaa-90bbb abc', ''),  # noqa: E501, E241
    ...
    test_data('abc aaa100bbb abc', [[(0, 0), (0, 0)]], {'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 10, 'subtract': True}, 'abc aaa90bbb abc', ''),  # noqa: E501, E241
    test_data('abc aaa-100bbb abc', [[(0, 0), (0, 0)]], {'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 10, 'subtract': True}, 'abc aaa-110bbb abc', ''),  # noqa: E501, E241

    test_data('abc aaa100bbb abc', [[(0, 8), (0, 8)]], {'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 10, 'subtract': True}, 'abc aaa90bbb abc', ''),  # noqa: E501, E241
    test_data('abc aaa-100bbb abc', [[(0, 8), (0, 8)]], {'mode': ViewTestCase.modes.INTERNAL_NORMAL, 'count': 10, 'subtract': True}, 'abc aaa-110bbb abc', ''),  # noqa: E501, E241

...
NORMAL_CASES = (
    test_data('0a23x5', (1, 1), 'x', ViewTestCase.NORMAL_MODE, (3, 3), 'Find ahead'),
    test_data('0ax345', (1, 1), 'x', ViewTestCase.NORMAL_MODE, (1, 1), 'Find next'),
...
INTERNAL_NORMAL_CASES = (
    test_data('0a23x5', (1, 1), 'x', ViewTestCase.INTERNAL_NORMAL_MODE, (1, 4), 'Find ahead'),
    test_data('0ax345', (1, 1), 'x', ViewTestCase.INTERNAL_NORMAL_MODE, (1, 2), 'Find next'),
    test_data('0x2345', (1, 1), 'x', ViewTestCase.INTERNAL_NORMAL_MODE, (1, 1), 'Find self'),
    test_data('0a2xx5', (1, 1), 'x', ViewTestCase.INTERNAL_NORMAL_MODE, (1, 3), 'Find multiple'),
    test_data('0x2x45', (1, 1), 'x', ViewTestCase.INTERNAL_NORMAL_MODE, (1, 3), 'Find self multiple'),
)

VISUAL_MULTI_CHAR_CASES = (
    test_data('0ab3x5', (1, 3), 'x', ViewTestCase.VISUAL_MODE, (1, 4), 'Forward'),
    test_data('0a23x5', (1, 5), 'x', ViewTestCase.VISUAL_MODE, (1, 5), 'Forward find b'),
    test_data('0b2xa5', (5, 1), 'x', ViewTestCase.VISUAL_MODE, (5, 2), 'Reverse no crossover'),
    test_data('0ba3x5', (3, 1), 'x', ViewTestCase.VISUAL_MODE, (2, 4), 'Reverse crossover'),
    test_data('0b2x45', (4, 1), 'x', ViewTestCase.VISUAL_MODE, (4, 2), 'Reverse find a'),
    test_data('0x2a45', (4, 1), 'x', ViewTestCase.VISUAL_MODE, (4, 1), 'Reverse find b'),
    test_data('0a2bx5', (1, 4), 'x', ViewTestCase.VISUAL_MODE, (1, 4), 'Forward find b+1'),
    test_data('0bx3a5', (5, 1), 'x', ViewTestCase.VISUAL_MODE, (5, 1), 'Reverse find b+1'),
    test_data('0b2ax5', (4, 1), 'x', ViewTestCase.VISUAL_MODE, (4, 3), 'Reverse find a+1'),
)

VISUAL_ONE_CHAR_CASES = (
    test_data('ax', (0, 2), 'x', ViewTestCase.VISUAL_MODE, (0, 2), 'Forward find b'),
    test_data('bx', (2, 0), 'x', ViewTestCase.VISUAL_MODE, (2, 0), 'Reverse find a'),
    test_data('fx', (0, 1), 'x', ViewTestCase.VISUAL_MODE, (0, 1), 'Forward find next'),
    test_data('rx', (1, 0), 'x', ViewTestCase.VISUAL_MODE, (1, 0), 'Reverse find next'),
...
VISUAL_MULTI_MATCHES_CASES = (
    test_data('0abxx5', (1, 3), 'x', ViewTestCase.VISUAL_MODE, (1, 3), 'Forward find first'),
    test_data('0axx45', (1, 3), 'x', ViewTestCase.VISUAL_MODE, (1, 3), 'Forward find b'),
    test_data('0bxx45', (3, 1), 'x', ViewTestCase.VISUAL_MODE, (3, 1), 'Reverse find a'),
    test_data('0bxx45', (4, 1), 'x', ViewTestCase.VISUAL_MODE, (4, 1), 'Reverse find a'),
    test_data('0xax45', (3, 1), 'x', ViewTestCase.VISUAL_MODE, (3, 2), 'Reverse find b'),
)

VISUAL_MULTI_LINE_CASES = (
    test_data('012\n456', (0, 5), '2', ViewTestCase.VISUAL_MODE, (0, 5), 'Select L1->L2, find on L1'),
    test_data('012\n456', (0, 5), '6', ViewTestCase.VISUAL_MODE, (0, 6), 'Select L1->L2, find on L2'),
    ...
    test_data('012\n456', (5, 0), '2', ViewTestCase.VISUAL_MODE, (5, 1), 'Select L2->L1, find on L1'),
    ...
    test_data('0123\n5678', (7, 5), '8', ViewTestCase.VISUAL_MODE, (6, 8), 'Select L2->LF+1, find on L2'),
)

SKIP_CASES = (
    test_data('xxxx', (1, 1), 'x', ViewTestCase.NORMAL_MODE, (2, 2), 'Skip past previous match'),
    test_data('xxxx', (2, 2), 'x', ViewTestCase.NORMAL_MODE, (2, 2), 'Does not skip past final match'),
)

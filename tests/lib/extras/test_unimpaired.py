...
class TestUnimpairedSquareBracket_Space(ViewTestCase):

    def test_blank_down(self):
        self.write('aaa\nbbb\nccc')
        self.select(6)
        self.view.run_command('neovintageous_unimpaired_blank_down')
    ...
    def test_blank_down_with_count(self):
        self.write('aaa\nbbb\nccc')
        self.select(6)
        self.view.run_command('neovintageous_unimpaired_blank_down', {'count': 5})
        self.assertContent('aaa\nbbb\n\n\n\n\n\nccc')
        self.assertSelection(4)
    ...
    def test_blank_up(self):
        self.write('aaa\nbbb\nccc')
        self.select(6)
        self.view.run_command('neovintageous_unimpaired_blank_up')
        self.assertContent('aaa\n\nbbb\nccc')
    ...
    def test_blank_up_with_count(self):
        self.write('aaa\nbbb\nccc')
        self.select(6)
        self.view.run_command('neovintageous_unimpaired_blank_up', {'count': 3})
        self.assertContent('aaa\n\n\n\nbbb\nccc')
...
class TestUnimpairedSquareBracket_e(ViewTestCase):

    def test_move_down(self):
        self.write('111\n222\n333\n444')
        self.select(6)
        self.view.run_command('neovintageous_unimpaired_move_down')
    ...
    def test_move_down_with_count(self):
        self.write('111\n222\n333\n444\n555\n666\n777\n888')
        self.select(6)
        self.view.run_command('neovintageous_unimpaired_move_down', {'count': 5})
        self.assertContent('111\n333\n444\n555\n666\n777\n222\n888')
    ...
    def test_move_up(self):
        self.write('111\n222\n333\n444')
        self.select(10)
        self.view.run_command('neovintageous_unimpaired_move_up')
        self.assertContent('111\n333\n222\n444')
    ...
    def test_move_up_with_count(self):
        self.write('111\n222\n333\n444\n555\n666\n777\n888')
        self.select(26)
        self.view.run_command('neovintageous_unimpaired_move_up', {'count': 3})
        self.assertContent('111\n222\n333\n777\n444\n555\n666\n888')

...
from NeoVintageous.lib.history import _char2type
from NeoVintageous.lib.history import _HIST_CMD
from NeoVintageous.lib.history import _HIST_DEBUG
from NeoVintageous.lib.history import _HIST_EXPR
from NeoVintageous.lib.history import _HIST_INPUT
from NeoVintageous.lib.history import _HIST_INVALID
from NeoVintageous.lib.history import _HIST_SEARCH
from NeoVintageous.lib.history import _history
from NeoVintageous.lib.history import _name2type
from NeoVintageous.lib.history import history_add
from NeoVintageous.lib.history import history_clear
from NeoVintageous.lib.history import history_del
...
from NeoVintageous.lib.history import history_nr
...
from NeoVintageous.lib.history import _storage as __storage_struct__


# Reusable mappings test patcher (also passes a clean storage structure to tests).
_patch_storage = unittest.mock.patch('NeoVintageous.lib.history._storage',
                                     new_callable=lambda: {k: {'num': 0, 'items': {}} for k in __storage_struct__})


_patch_max_items = lambda n: unittest.mock.patch('NeoVintageous.lib.history._MAX_ITEMS', n)  # noqa: E731

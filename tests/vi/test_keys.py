...
TESTS_KNOWN_SEQUENCES = (
    ...
    seq_test(actual=seqs.CTRL_W_B,               expected='<C-w>b'),
    seq_test(actual=seqs.CTRL_W_CTRL_B,          expected='<C-w><C-b>'),
    seq_test(actual=seqs.CTRL_W_BIG_H,           expected='<C-w>H'),
    seq_test(actual=seqs.CTRL_W_BIG_J,           expected='<C-w>J'),
    seq_test(actual=seqs.CTRL_W_BIG_K,           expected='<C-w>K'),
    seq_test(actual=seqs.CTRL_W_BIG_L,           expected='<C-w>L'),
    seq_test(actual=seqs.CTRL_W_C,               expected='<C-w>c'),
    seq_test(actual=seqs.CTRL_W_EQUAL,           expected='<C-w>='),
    seq_test(actual=seqs.CTRL_W_GREATER_THAN,    expected='<C-w>>'),
    seq_test(actual=seqs.CTRL_W_H,               expected='<C-w>h'),
    seq_test(actual=seqs.CTRL_W_J,               expected='<C-w>j'),
    seq_test(actual=seqs.CTRL_W_K,               expected='<C-w>k'),
    seq_test(actual=seqs.CTRL_W_L,               expected='<C-w>l'),
    seq_test(actual=seqs.CTRL_W_CTRL_H,          expected='<C-w><C-h>'),
    seq_test(actual=seqs.CTRL_W_CTRL_J,          expected='<C-w><C-j>'),
    seq_test(actual=seqs.CTRL_W_CTRL_K,          expected='<C-w><C-k>'),
    seq_test(actual=seqs.CTRL_W_CTRL_L,          expected='<C-w><C-l>'),
    seq_test(actual=seqs.CTRL_W_LESS_THAN,       expected='<C-w><lt>'),
    seq_test(actual=seqs.CTRL_W_MINUS,           expected='<C-w>-'),
    seq_test(actual=seqs.CTRL_W_N,               expected='<C-w>n'),
    seq_test(actual=seqs.CTRL_W_CTRL_N,          expected='<C-w><C-n>'),
    seq_test(actual=seqs.CTRL_W_O,               expected='<C-w>o'),
    seq_test(actual=seqs.CTRL_W_CTRL_O,          expected='<C-w><C-o>'),
    seq_test(actual=seqs.CTRL_W_PIPE,            expected='<C-w>|'),
    seq_test(actual=seqs.CTRL_W_PLUS,            expected='<C-w>+'),
    seq_test(actual=seqs.CTRL_W_Q,               expected='<C-w>q'),
    seq_test(actual=seqs.CTRL_W_CTRL_Q,          expected='<C-w><C-q>'),
    seq_test(actual=seqs.CTRL_W_S,               expected='<C-w>s'),
    seq_test(actual=seqs.CTRL_W_BIG_S,           expected='<C-w>S'),
    seq_test(actual=seqs.CTRL_W_CTRL_S,          expected='<C-w><C-s>'),
    seq_test(actual=seqs.CTRL_W_T,               expected='<C-w>t'),
    seq_test(actual=seqs.CTRL_W_CTRL_T,          expected='<C-w><C-t>'),
    seq_test(actual=seqs.CTRL_W_UNDERSCORE,      expected='<C-w>_'),
    seq_test(actual=seqs.CTRL_W_CTRL_UNDERSCORE, expected='<C-w><C-_>'),
    seq_test(actual=seqs.CTRL_W_V,               expected='<C-w>v'),
    seq_test(actual=seqs.CTRL_W_CTRL_V,          expected='<C-w><C-v>'),
    seq_test(actual=seqs.CTRL_W_X,               expected='<C-w>x'),
    seq_test(actual=seqs.CTRL_W_CTRL_X,          expected='<C-w><C-x>'),
    seq_test(actual=seqs.CTRL_W_UP,              expected='<C-w><up>'),
    seq_test(actual=seqs.CTRL_W_DOWN,            expected='<C-w><down>'),
    seq_test(actual=seqs.CTRL_W_LEFT,            expected='<C-w><left>'),
    seq_test(actual=seqs.CTRL_W_RIGHT,           expected='<C-w><right>'),
    seq_test(actual=seqs.CTRL_W_BACKSPACE,       expected='<C-w><bs>'),

...
class TestSublime(unittest.FunctionalTestCase):
    ...
    @unittest.mock_run_commands('prompt_select_workspace')
    ...
    @unittest.mock_run_commands('toggle_side_bar')
    ...
    @unittest.mock_run_commands('show_overlay')
    ...
    @unittest.mock_run_commands('toggle_bookmark')

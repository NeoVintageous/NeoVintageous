...
TESTS_MODES = (
    # NORMAL mode
    test_data(cmd='_vi_h', initial_text='abc', regions=[[1, 1]], cmd_params={'mode': unittest.NORMAL},
              expected=region_data([0, 0]), actual_func=first_sel, msg='should move back one char (normal mode)'),
    test_data(cmd='_vi_h', initial_text='foo bar baz', regions=[[1, 1]], cmd_params={'mode': unittest.NORMAL, 'count': 10},  # noqa: E241,E501
              expected=region_data([0, 0]), actual_func=first_sel, msg='should move back one char with count (normal mode)'),  # noqa: E241,E501
    test_data(cmd='_vi_h', initial_text='abc', regions=[[1, 1]], cmd_params={'mode': unittest.NORMAL, 'count': 10000},  # noqa: E241,E501
              expected=region_data([0, 0]), actual_func=first_sel, msg='should move back one char with large count (normal mode)'),  # noqa: E241,E501

    test_data(cmd='_vi_h', initial_text='abc', regions=[[1, 1]], cmd_params={'mode': unittest.INTERNAL_NORMAL},  # noqa: E241,E501
              expected=region_data([1, 0]), actual_func=first_sel, msg='should select one char (internal normal mode)'),  # noqa: E241,E501
    test_data(cmd='_vi_h', initial_text='foo bar baz', regions=[[10, 10]], cmd_params={'mode': unittest.INTERNAL_NORMAL},  # noqa: E241,E501
              expected=region_data([10, 9]), actual_func=first_sel, msg='should select one char from eol (internal normal mode)'),  # noqa: E241,E501
    test_data(cmd='_vi_h', initial_text='foo bar baz', regions=[[1, 1]], cmd_params={'mode': unittest.INTERNAL_NORMAL, 'count': 10000},  # noqa: E241,E501
    ...
    test_data(cmd='_vi_h', initial_text='abc', regions=[[1, 2]], cmd_params={'mode': unittest.VISUAL},
              expected=region_data([2, 0]), actual_func=first_sel, msg='should select one char (visual mode)'),
    test_data(cmd='_vi_h', initial_text='abc', regions=[[1, 3]], cmd_params={'mode': unittest.VISUAL, 'count': 1},  # noqa: E241,E501
              expected=region_data([1, 2]), actual_func=first_sel, msg='should deselect one char (visual mode)'),
    test_data(cmd='_vi_h', initial_text='abc', regions=[[1, 3]], cmd_params={'mode': unittest.VISUAL, 'count': 2},  # noqa: E241,E501
              expected=region_data([2, 0]), actual_func=first_sel, msg='should go back two chars (visual mode) crossing over'),  # noqa: E241,E501

    test_data(cmd='_vi_h', initial_text='abc', regions=[[1, 3]], cmd_params={'mode': unittest.VISUAL, 'count': 100},  # noqa: E241,E501
              expected=region_data([2, 0]), actual_func=first_sel, msg='can move reversed cross over large count visual mode'),  # noqa: E241,E501
    test_data(cmd='_vi_h', initial_text='foo bar fuzz buzz', regions=[[11, 12]], cmd_params={'mode': unittest.VISUAL, 'count': 10},  # noqa: E241,E501

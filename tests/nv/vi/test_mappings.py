...
from NeoVintageous.nv.vi.mappings import CMD_TYPE_USER
from NeoVintageous.nv.vi.mappings import INSERT
from NeoVintageous.nv.vi.mappings import Mapping
from NeoVintageous.nv.vi.mappings import _STATUS_COMPLETE
from NeoVintageous.nv.vi.mappings import _STATUS_INCOMPLETE
from NeoVintageous.nv.vi.mappings import Mappings
from NeoVintageous.nv.vi.mappings import NORMAL
from NeoVintageous.nv.vi.mappings import OPERATOR_PENDING
from NeoVintageous.nv.vi.mappings import SELECT
from NeoVintageous.nv.vi.mappings import VISUAL_BLOCK
from NeoVintageous.nv.vi.mappings import VISUAL_LINE
from NeoVintageous.nv.vi.mappings import VISUAL
...
from NeoVintageous.nv.vi.mappings import _mappings as __mappings_struct__


# Reusable mappings test patcher (also passes a clean mappings structure to tests).
_patch_mappings = unittest.mock.patch('NeoVintageous.nv.vi.mappings._mappings',

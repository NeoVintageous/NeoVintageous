...
from NeoVintageous.nv.vi.variables import _DEFAULTS
from NeoVintageous.nv.vi.variables import _SPECIAL_STRINGS
from NeoVintageous.nv.vi.variables import _VARIABLES

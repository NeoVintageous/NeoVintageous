...
class TestToBareCommandName(unittest.TestCase):
    ...
    def test_basic(self):
        self.assertEqual('0', to_bare_command_name('0'))
        self.assertEqual('<f7>', to_bare_command_name('"210<f7>'))
        self.assertEqual('<f7>', to_bare_command_name('"a10<f7>'))
        self.assertEqual('<f7>', to_bare_command_name('10<f7>'))
        self.assertEqual('<f7>', to_bare_command_name('<f7>'))
        self.assertEqual('daw', to_bare_command_name('"12d2aw'))
        self.assertEqual('daw', to_bare_command_name('"a2d2aw'))
        self.assertEqual('daw', to_bare_command_name('2d2aw'))
        self.assertEqual('daw', to_bare_command_name('2daw'))
        self.assertEqual('daw', to_bare_command_name('d2aw'))
        self.assertEqual('daw', to_bare_command_name('daw'))
        self.assertEqual('dd', to_bare_command_name('d2d'))

...
class TestRcfile(unittest.TestCase):
    ...
    def test_parse_line_return_none_for_non_commands(self):
        ...
        self.assertEqual(None, _parse_line('" foobar'))
        self.assertEqual(None, _parse_line('":let mapleader=,'))
        self.assertEqual(None, _parse_line('":map x zy'))
        self.assertEqual(None, _parse_line('":noremap x zy'))
        self.assertEqual(None, _parse_line('zap x zy'))

    def test_parse_line_returns_valid_commands(self):
        self.assertEqual(':let mapleader=,', _parse_line(':let mapleader=,'))
        self.assertEqual(':noremap x yz', _parse_line(':noremap x yz'))
        self.assertEqual(':inoremap x yz', _parse_line(':inoremap x yz'))
        self.assertEqual(':nnoremap x yz', _parse_line(':nnoremap x yz'))
        self.assertEqual(':onoremap x yz', _parse_line(':onoremap x yz'))
        self.assertEqual(':snoremap x yz', _parse_line(':snoremap x yz'))
        self.assertEqual(':vnoremap x yz', _parse_line(':vnoremap x yz'))
        self.assertEqual(':xnoremap x yz', _parse_line(':xnoremap x yz'))
        self.assertEqual(':unmap x', _parse_line(':unmap x'))
        self.assertEqual(':nunmap x', _parse_line(':nunmap x'))
        self.assertEqual(':ounmap x', _parse_line(':ounmap x'))
        self.assertEqual(':sunmap x', _parse_line(':sunmap x'))
        self.assertEqual(':vunmap x', _parse_line(':vunmap x'))
        self.assertEqual(':xunmap x', _parse_line(':xunmap x'))
    ...
    def test_parse_line_returns_none_for_recursive_mapping_commands(self):
        ...
        self.assertEqual(None, _parse_line(':map x yz'))
        self.assertEqual(None, _parse_line(':imap x yz'))
        self.assertEqual(None, _parse_line(':nmap x yz'))
        self.assertEqual(None, _parse_line(':omap x yz'))
        self.assertEqual(None, _parse_line(':smap x yz'))
        self.assertEqual(None, _parse_line(':vmap x yz'))
        self.assertEqual(None, _parse_line(':xmap x yz'))
        self.assertEqual(None, _parse_line('map x yz'))
        self.assertEqual(None, _parse_line('imap x yz'))
        self.assertEqual(None, _parse_line('nmap x yz'))
        self.assertEqual(None, _parse_line('omap x yz'))
    ...
    def test_unescaped_pipe_character_is_invalid(self, message):
        ...
        for i, test in enumerate(tests):
            self.assertEqual(None, _parse_line(test))
